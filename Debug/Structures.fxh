...
struct GlobalConstants
{
    ...
    float MaxRayLength;
    float AmbientLight;
    float   BounceAmp;      // <--- NUEVA LÍNEA

    float3 MoveDir;   // dirección de movimiento en X,Z
    float FlowAmp;    // amplitud de “corrimiento” gelatinoso horizontal
...
struct ObjectAttribs
{
    ...
    float    MinY;    // <-- altura mínima de la malla en local
    float    MaxY;    // <-- altura máxima de la malla en local
};
